...
import com.skyblue.skybluea.databinding.ActivityName2Binding;
...
public class NameActivity2 extends AppCompatActivity {
    ...
    private void Signup() {
        ...
        String mMobileNo = getIntent().getStringExtra("mobile");
        String mMobileNoFull = getIntent().getStringExtra("mobile_full");
        String mPhoneCode = getIntent().getStringExtra("phone_code");
        String mCountry = getIntent().getStringExtra("country_name");
        ...
        RequestBody requestBody = new MultipartBody.Builder()
                ...
                .addFormDataPart("mobile_with_plus", mMobileNoFull)
                .addFormDataPart("mobile", mMobileNo)
                .addFormDataPart("country", mCountry)
                .addFormDataPart("phone_code", mPhoneCode)
