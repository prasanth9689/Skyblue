...
public class PageCreateEduAddressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_edu_create_address);
    ...
    private void CREATEPAGE() {
        ...
        progressDialog = new ProgressDialog(PageCreateEduAddressActivity.this, R.style.AppCompatAlertDialogStyle);
        ...
        String page_id = getIntent().getStringExtra("page_id");
        String pageCommonNameHolder = "Page Test CommonName";
      ...
      //  String name = getIntent().getStringExtra("page_name");
        ...
        AndroidNetworking.post("https://www.skyblue-watch.xyz/web/handle/pages/create_page.php")
                .addBodyParameter("user_id", userIdHolderShared)
                .addBodyParameter("name", name)
                .addBodyParameter("common_name", pageCommonNameHolder)
                .addBodyParameter("common_id", page_id)
                .addBodyParameter("date_added", timeDateString)
                .addBodyParameter("description", des)
                .addBodyParameter("spinner", spinner)
                ...
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(PageCreateEduAddressActivity.this,"Page created",Toast.LENGTH_SHORT).show();
                    ...
                    public void onError(ANError anError) {
                        ...
                        Toast.makeText(PageCreateEduAddressActivity.this,"Error",Toast.LENGTH_SHORT).show();
                        progressDialog.dismiss();
                    }
                });
    }
