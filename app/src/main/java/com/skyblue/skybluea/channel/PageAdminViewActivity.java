...
public class PageAdminViewActivity extends AppCompatActivity {
    ...
    String logoHolder , coverHolder ;

    ImageView logoImageView , coverImageView;
    TextView nameTxt , secondaryTxt;
    Button editBtn;

    private static final String GET_PROFILE_COVER = "https://www.skyblue-watch.xyz/web/handle/pages/get_logo_cover_by_page_id.php";

    RelativeLayout coverAdd , logoAdd , followerList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_admin_view);

        logoImageView = findViewById(R.id.id_logo);
        coverImageView = findViewById(R.id.id_cover);
        nameTxt = findViewById(R.id.id_name);
        secondaryTxt = findViewById(R.id.id_secondary);
        editBtn = findViewById(R.id.id_edit_button);
        coverAdd = findViewById(R.id.Rel_update_cover);
        logoAdd = findViewById(R.id.id_update_logo);
        followerList = findViewById(R.id.rel_total_likes);
        postBtn = findViewById(R.id.post_btn);
        backButton = findViewById(R.id.id_back);
        settingButton = findViewById(R.id.id_setting_btn);
        ...
        settingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, PageAdminSettings.class);
...
/*
         ...
         pin_code = getIntent().getStringExtra("pin_code");
 ...
 */
        ...
        //    Toast.makeText(context, cover,Toast.LENGTH_LONG).show();
        ...
        //   secondaryTxt.setText(common_name);
        ...
        followerList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PageAdminFollowerListActivity.class);
                startActivity(intent);
            }
        });

        logoAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                String image_id_update_page_logo_through_page_view_admin = "5";
                String image_id_update_page_cover_through_page_view_admin = "6";
        /*
         ...
         */
                ...
                i.putExtra("common_id", page_id);
                i.putExtra("image_id", image_id_update_page_logo_through_page_view_admin);
                startActivity(i);
                finish();
        ...
        coverAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
         ...
         */
                ...
                Intent i = new Intent(context, MainActivity.class);
                i.putExtra("common_id", page_id);
                i.putExtra("image_id", image_id_update_page_cover_through_page_view_admin);
                startActivity(i);
                finish();
        ...
        coverImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(KEY_EMPTY.equals(coverHolder)){
                    String image_id_post_picture = "1";
                    String image_id_update_profile_picture_init = "2";
                    String image_id_update_cover_picture = "3";
                    String image_id_update_profile_picture_through_account_activity = "4";
         ...
         */
               ...
               -> Remove log picture and Cover picture indicates by : image_r_id
         ...
         */
                    ...
                    Intent intent = new Intent(context, PageAdminLogoViewActivity.class);
                    intent.putExtra("page_id", page_id);
                    intent.putExtra("image_r_id", image_r_id_Cover);
                    intent.putExtra("image_url", coverHolder);
                    intent.putExtra("picture_name", userProfileImage);
                    startActivity(intent);
        ...
        logoImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(KEY_EMPTY.equals(logoHolder)){
                    String image_id_post_picture = "1";
                    String image_id_update_profile_picture_init = "2";
                    String image_id_update_cover_picture = "3";
                    String image_id_update_profile_picture_through_account_activity = "4";
         ...
         */
                    String image_r_id_Cover = "11";
                    String userProfileImage = "Logo picture";


                    Intent intent = new Intent(context, PageAdminLogoViewActivity.class);
                    intent.putExtra("page_id", page_id);
                    intent.putExtra("image_r_id", image_r_id_Cover);
                    intent.putExtra("image_url", logoHolder);
                    intent.putExtra("picture_name", userProfileImage);
                    startActivity(intent);
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (Integer.parseInt(common_id)) {
                    ...
                    case 1:
                        Intent intent = new Intent(context, PageAdminUpdateActivity.class);
                        ...
                        break;
                    case 2:
                        Intent intent2 = new Intent(context, PageAdminUpdateTwoActivity.class);
                        intent2.putExtra("page_id", page_id);
                        startActivity(intent2);
                        break;

                    case 3:
                        Intent intent1 = new Intent(context, PageAdminUpdateActivity.class);

                        intent1.putExtra("page_id", page_id);

                        startActivity(intent1);
                        break;

                    case 4:
                        Intent intent3 = new Intent(context, PageAdminUpdateTwoActivity.class);
    ...
    private void PostNow() {
        ...
        AndroidNetworking.post("https://www.skyblue-watch.xyz/web/handle/pages/page_post/picture/post_picture.php")
                .addBodyParameter("user_id", user_id)
                .addBodyParameter("page_id", page_id)
                .addBodyParameter("common_id", common_id)
                .addBodyParameter("post_text", toServerUnicodeEncoded)
    ...
    private void LoadPage() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_PROFILE_COVER,
                        ...
                        try {
                            ...
                            if (jsonObjectluser.optString("status").equals("true"))
                            {
                                ...
                                for (int i = 0; i < jsonArrayst.length(); i++) {
                                    ...
                                    Model.setLogo(dataobjst.getString("logo"));
                                    Model.setCover(dataobjst.getString("cover"));
                                ...
                                for (int j = 0; j < ArrayList.size(); j++) {
                                    ...
                                    coverHolder = ArrayList.get(j).getCover();
                                    logoHolder = ArrayList.get(j).getLogo();


                                    Glide
                                            .with(context)
                                            .load(ArrayList.get(j).getLogo())
                                            .apply(RequestOptions.circleCropTransform())
                                            .placeholder(R.drawable.flag)
                                            .into(logoImageView);

                                    //UserIdTempTxtHolder = ArrayList.get(j).getName();
                                    Glide
                                            .with(context)
                                            .load(ArrayList.get(j).getCover())
                                            .placeholder(R.drawable.placeholder_bg_gray)
                                            .into(coverImageView);

                                    String newStringEmojidecooded = "";

                                    try {
                                        byte[] data = Base64.decode(ArrayList.get(j).getName(), Base64.DEFAULT);
                                    ...
                                    secondaryTxt.setText(ArrayList.get(j).getCommon_name());
                                }
    ...
    class PageIn {
        ...
        private String id, name , common_name , logo , cover ;
    ...
    public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            v = LayoutInflater.from(context).inflate(R.layout.row_model_page_admin_view, parent, false);
        ...
        public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
            ...
            holder.txtPostUserName.setText(newEmojidecodedPostUserName);
