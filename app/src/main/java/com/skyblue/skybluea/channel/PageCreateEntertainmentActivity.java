...
public class PageCreateEntertainmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_create_entertainment);
    ...
    private void CREATEPAGE() {
        ...
        progressDialog = new ProgressDialog(PageCreateEntertainmentActivity.this, R.style.AppCompatAlertDialogStyle);
        ...
        AndroidNetworking.post("https://www.skyblue-watch.xyz/web/handle/pages/entertainment/create_page.php")
                ...
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(PageCreateEntertainmentActivity.this,"Page created",Toast.LENGTH_SHORT).show();
                    ...
                    public void onError(ANError anError) {
                        ...
                        Toast.makeText(PageCreateEntertainmentActivity.this,"Error",Toast.LENGTH_SHORT).show();
                        progressDialog.dismiss();
                    }
                });
    }
