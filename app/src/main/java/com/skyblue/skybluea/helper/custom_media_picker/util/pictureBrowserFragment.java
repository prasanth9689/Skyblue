...
import com.skyblue.skybluea.helper.custom_media_picker.util.recyclerViewPagerImageIndicator;
import com.skyblue.skybluea.helper.custom_media_picker.util.pictureFacer;
import com.skyblue.skybluea.helper.custom_media_picker.util.imageIndicatorListener;
import com.skyblue.skybluea.helper.custom_media_picker.util.imageIndicatorListener;
import com.skyblue.skybluea.helper.custom_media_picker.util.pictureFacer;
import com.skyblue.skybluea.helper.custom_media_picker.util.recyclerViewPagerImageIndicator;
...
public class pictureBrowserFragment extends Fragment implements imageIndicatorListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        postBR = view.findViewById(R.id.post_btnr);
...
//                Uri sendUri = Uri.fromFile(new File(pic.getPicturePath()));
//
//                Intent intent = new Intent(getContext(), PostPictureActivity.class);
