...
import com.skyblue.skybluea.utils.imageFolder;
import com.skyblue.skybluea.utils.itemClickListener;
import com.skyblue.skybluea.utils.pictureFacer;
import com.skyblue.skybluea.utils.pictureFolderAdapter;

import java.util.ArrayList;

public class VideoSelectorDisplay extends AppCompatActivity implements itemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  setContentView(R.layout.activity_video_selector_display);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        setContentView(R.layout.activity_main);

        empty =findViewById(R.id.empty);
        backBtn = findViewById(R.id.back_video_selector_display);
        ...
        if(folds.isEmpty()){
            ...
            RecyclerView.Adapter folderAdapter = new pictureFolderAdapter(folds,VideoSelectorDisplay.this,this);
    ...
    public void onPicClicked(String pictureFolderPath,String folderName) {
        Intent move = new Intent(VideoSelectorDisplay.this,VideoSelectorImageDisplay.class);
