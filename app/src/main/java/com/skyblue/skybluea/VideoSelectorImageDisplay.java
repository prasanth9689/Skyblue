...
import com.skyblue.skybluea.utils.video_adapter;

import java.util.ArrayList;

public class VideoSelectorImageDisplay extends AppCompatActivity implements itemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_selector_image_display);

        folderName = findViewById(R.id.foldername);
        backButton = findViewById(R.id.back_video_selector_image_display);
        ...
        if(allpictures.isEmpty()){
            ...
            imageRecycler.setAdapter(new video_adapter(allpictures,VideoSelectorImageDisplay.this,this));
    ...
    public void onPicClicked(PicHolder holder, int position, ArrayList<pictureFacer> pics) {
        ...
        pictureBrowserFragment browser = pictureBrowserFragment.newInstance(pics,position,VideoSelectorImageDisplay.this);
    ...
    public ArrayList<pictureFacer> getAllImagesByFolder(String path){
        ...
        Cursor cursor = VideoSelectorImageDisplay.this.getContentResolver().query( allVideosuri, projection, MediaStore.Video.Media.DATA + " like ? ", new String[] {"%"+path+"%"}, null);
        try {
            cursor.moveToFirst();
            do{
